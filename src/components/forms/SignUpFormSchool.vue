  ...
  <div class="column q-gutter-y-md">
    ...
    >
      ...
      <q-input
        ...
        lazy-rules
        :rules="[
          (val) => validateStringRequired(val) || 'Please enter your school code',
          (val) => validateAlphanumeric(val) || 'School code must contain only letters and digits',
          (val) => val.length === 5 || 'School code should consist of 5 characters',
        ]"
      />
